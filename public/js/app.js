...
var _user$project$Utils_FormatDate$reverseDate = function (_p1) {
	return A2(
		_elm_lang$core$String$join,
		'-',
...
var _user$project$Utils_FormatDate$formatDate = function (rawdate) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Basics$toString(
			_elm_lang$core$Date$year(rawdate)),
		A2(
			_elm_lang$core$Basics_ops['++'],
			'-',
			A2(
				...
				if (_p3._0.ctor === 'Nothing') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{date: newDate}),
						_1: _user$project$Update$getAsteroids(newDate)
					};
				}
			case 'AsteroidRequest':
				if (_p3._0.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
			...
			case 'PreviousSetting':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							setting: _user$project$Utils_ChangeSettings$previousSetting(model.setting)
						}),
					{ctor: '[]'});
			default:
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					A2(_user$project$Update$setOrientation, _p3._0, model),
					{ctor: '[]'});
		}
	});

var _user$project$Styles_Classes$scaleSwitch = function (setting) {
	var _p0 = setting;
	if (_p0.ctor === 'Name') {
		return ' scaleoff';
	} else {
...
var _user$project$Views_Error$errorHandler = function (errormessage) {
	...
	if (_p0.ctor === 'Error') {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class(_user$project$Styles_Classes$tachs.error),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
...
var _user$project$Views_Nav$navigation = F3(
	function (prevSettingMsg, setting, nextSettingMsg) {
		var settingtext = function () {
			var _p0 = setting;
			switch (_p0.ctor) {
				case 'Name':
					return 'Name';
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class(_user$project$Styles_Classes$tachs.nav),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class(_user$project$Styles_Classes$tachs.navbutton),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(prevSettingMsg),
							_1: {ctor: '[]'}
						}
					},
					{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class(_user$project$Styles_Classes$tachs.navtext),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(settingtext),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$button,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(nextSettingMsg),
									_1: {ctor: '[]'}
								}
							},
							{
...
var _user$project$Styles_Colours$rgbToString = function (_p0) {
	var _p1 = _p0;
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'rgb(',
		A2(
			_elm_lang$core$Basics_ops['++'],
			_elm_lang$core$Basics$toString(_p1.red),
			A2(
				_elm_lang$core$Basics_ops['++'],
				',',
				A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$core$Basics$toString(_p1.blue),
					A2(
						_elm_lang$core$Basics_ops['++'],
						',',
						A2(
							_elm_lang$core$Basics_ops['++'],
							_elm_lang$core$Basics$toString(_p1.green),
							')'))))));
};
var _user$project$Styles_Colours$buildSwatches = F3(
	function (total, s, l) {
		return _elm_lang$core$Array$fromList(
			A2(
				_elm_lang$core$List$map,
				function (x) {
					return _user$project$Styles_Colours$rgbToString(
						_elm_lang$core$Color$toRgb(x));
				},
				A2(
					_elm_lang$core$List$map,
					function (x) {
...
var _user$project$Styles_Colours$getPastel = function (index) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		'rgb(100,100,100)',
		A2(_elm_lang$core$Array$get, index, _user$project$Styles_Colours$pastelSwatches));
};
var _user$project$Styles_Colours$Rgb = F4(
	function (a, b, c, d) {
...
var _user$project$Utils_FormatNumbers$kmString = function (_p3) {
	return A3(
		...
		'km',
		_user$project$Utils_FormatNumbers$formatFloat(_p3));
};
var _user$project$Utils_FormatNumbers$kmsString = function (_p4) {
	return A3(
		_elm_lang$core$Basics$flip,
		F2(
			function (x, y) {
		...
		'/s',
		_user$project$Utils_FormatNumbers$kmString(_p4));
};
...
var _user$project$Views_Svg$svgText = F2(
	function (_p0, displaytext) {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$x(_p1._0),
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$y(_p1._1),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$textAnchor('middle'),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$class(_user$project$Styles_Classes$tachs.svgtext),
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$fill(_user$project$Styles_Classes$tachs.svgtextcol),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _user$project$Views_Svg$svgCircle = F3(
	function (index, _p2, rad) {
		var _p3 = _p2;
		return A2(
			_elm_lang$svg$Svg$circle,
			{
				...
				_0: _elm_lang$svg$Svg_Attributes$fill(
					_user$project$Styles_Colours$getPastel(index)),
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$cx(_p3._0),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$cy(_p3._1),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$r(rad),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _user$project$Views_Svg$orientationMap = F3(
	function (a, b, orientation) {
		var _p4 = orientation;
		if (_p4.ctor === 'Landscape') {
			return {ctor: '_Tuple2', _0: a, _1: b};
		} else {
			return {ctor: '_Tuple2', _0: b, _1: a};
		}
	});
var _user$project$Views_Svg$dataGroup = F3(
	function (_p6, _p5, orientation) {
		var _p7 = _p6;
		var _p8 = _p5;
		var _p9 = A3(_user$project$Views_Svg$orientationMap, _p8._0, _p8._1, orientation);
		var a = _p9._0;
		var b = _p9._1;
		var xScaled = _elm_lang$core$Basics$toString(
			_p7.x * _elm_lang$core$Basics$toFloat(a));
		var yScaled = _elm_lang$core$Basics$toString(
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$class(_user$project$Styles_Classes$tachs.svgasteroid),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A3(_user$project$Views_Svg$svgCircle, _p7.index, coords, rScaled),
				_1: {
					ctor: '::',
					_0: A2(_user$project$Views_Svg$svgText, coords, _p7.display),
					_1: {ctor: '[]'}
				}
			});
	});
var _user$project$Views_Svg$asteroidSvg = F3(
	function (setting, asteroids, orientation) {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$class(_user$project$Styles_Classes$tachs.svg),
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$viewBox(svgViewBox),
					_1: {ctor: '[]'}
				}
			},
			A2(
				...
				function (item) {
					return A3(
						_user$project$Views_Svg$dataGroup,
						item,
					...
					_0: A2(
						_elm_lang$html$Html$div,
						{
							...
							_0: _elm_lang$html$Html_Attributes$class(
								A2(
									_elm_lang$core$Basics_ops['++'],
									_user$project$Styles_Classes$tachs.svgcontainer,
									_user$project$Styles_Classes$scaleSwitch(_p2))),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Date.Date":{"args":[],"tags":{"Date":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Types.Msg":{"args":[],"tags":{"Resize":["Int"],"SetDate":["Maybe.Maybe Date.Date"],"NextSetting":[],"PreviousSetting":[],"AsteroidRequest":["Result.Result Http.Error Types.AsteroidList"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Types.Asteroid":{"args":[],"type":"{ name : String , minsize : Float , speed : Float , missdistance : Float }"},"Types.AsteroidList":{"args":[],"type":"List Types.Asteroid"}},"message":"Types.Msg"},"versions":{"elm":"0.18.0"}});
}
